...
export function getConditionIconBig(key: string): JSX.Element {
  const conditionIcons: { [k: string]: JSX.Element } = {
    ...
    lightShowers: (
      <CloudRain size={64} className='animate-pulse text-blue-500' />
    ),
  ...
  return (
    conditionIcons[key] || (
      <CircleQuestionMark size={64} className='animate-pulse text-gray-500' />
    )
  );
}
